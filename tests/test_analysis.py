...
def perform_regression_analysis_parallel(df, top_n=1, max_k=None, cpu_count=mp.cpu_count()-2):
    """
    ...
    # インデックスの整合性を確認
    if not response.index.equals(df.index):
    ...
    return best_models_adj_r_squared, best_predictors_list, best_X_adj_r_squared, response
